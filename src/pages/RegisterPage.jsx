                ...
                <RadioGroup value={userType} onValueChange={setUserType}>
                  <div className="flex items-center space-x-2 p-3 border rounded-lg hover:bg-gray-50">
                    ...
                    <Label htmlFor="customer" className="flex items-center space-x-2 cursor-pointer flex-1">
                      ...
                      <div>
                        <div className="font-medium">Find professionals</div>
                  ...
                  <div className="flex items-center space-x-2 p-3 border rounded-lg hover:bg-gray-50">
                    ...
                    <Label htmlFor="professional" className="flex items-center space-x-2 cursor-pointer flex-1">
                      <Briefcase className="h-4 w-4 text-green-600" />
                      <div>
                        <div className="font-medium">Offer services</div>
                        <div className="text-sm text-gray-500">I'm a professional</div>
                      </div>
                    </Label>
                  </div>
                </RadioGroup>
